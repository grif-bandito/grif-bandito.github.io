...
<img src="../assets/images/surface-book/TEMPcover.jpg" alt="Panel Measurement" height="400" style="margin: 15px;"> 
...
The Surface Book 1 was a genuine test of that philosophy. I had gotten it around 2016 and it has laid dormant since roughly 2019. It became unable due to a mysterious bulge 
...
<p align="center">
  <img src="../assets/images/surface-book/FaceToFace.jpg" alt="Board Exposure" height="250" style="margin: 5px;">
  <img src="../assets/images/surface-book/Scrape.jpg" alt="Battery Cell View" height="250" style="margin: 5px;">
  <img src="../assets/images/surface-book/LockMech.jpg" alt="Panel Measurement" height="250" style="margin: 5px;">
  <img src="../assets/images/surface-book/ProppedUp.jpg" alt="Panel Measurement" height="250" style="margin: 5px;">
...
<p align="center">
  <img src="../assets/images/surface-book/Pry.jpg" alt="Board Exposure" height="300" style="margin: 5px;">
  <img src="../assets/images/surface-book/Wedge.jpg" alt="Panel Measurement" height="300" style="margin: 5px;">
  <img src="../assets/images/surface-book/Lift002.jpg" alt="Battery Cell View" height="300" style="margin: 5px;">
  <img src="../assets/images/surface-book/70_.jpg" alt="Battery Cell View" height="300" style="margin: 5px;">
...
<details markdown="1">
<summary><b></b>2026-04-28: Yellow-Label Luck</summary>b></summary>

### Clean up_

The motherboard and company are back in place, those tiny screws were moderately uncooperative, but all is well. The only mishap, i lost the two screws needed for the fan, i tried moving some native screws around, tried using some left over screws from the ASUS and even tried some old mac book screws... nothing threads. It seems i managed to lose the only two screws that would seat in the fans mounting holes, so resorted to electrical tape, seems secure enough. I layered some black electrical tape over the area where the cells and connector board used to be, electrical tape is a tad difficult to work with as my arts and craft skills are... lacking. Looks pretty clean and the yellow strips of tape i laid down at the top and side edges where the screen was adhered, had to be cut to about an 1/8 of an inch in width, which was a bit tedious, but I'm happy with how it turned out. Took some time to tape the antenna wires and locking mechanism wires back down to the fame and do a last check for glass and debris. With all that in place, the marred up magnesium and slight stickiness from the adhesive residue is covered up and the lose wires are secure, making the inner chassis look much cleaner now. 

### Plexiglass Protector_

The plexiglass, as mentioned in the 70% Downtime log is 1 mm thick, 5x8 inches and i have 5 sheets. The screen area needed to be covered is 9 inches in height by 12 inches in length. I cut the extra inch off of one sheet of the plexiglass to make it 8x9 in and took another sheet, cutting it down to 4x9in. Super gluing them end to end to get the 9x12 dimension needed and supporting the seam with a 1x9 in strip of scrap plexiglass. I ended up using a two strips of yellow electrical tape, one to cover the seam on the outside and the other to cover the support strip on the inside as to protect the internals. Despite the motherboard being upside down and already protected, better safe than sorry. Rounding off the corners, applying 4 strips of black electrical tape, 2 on either edge of the mended plexiglass sheet and 2 for the back of the surfaces books chassis to protect and provide grip for the 4, 20 mm clamps... the surface book officially has a "screen" again. Plexiglass is actually very insulating, even at 1 mm thick it would most likely be more insulating that the original screen as that screen was designed to be a heat sink. So ill need to modify it further.

After a dry fit, clamping it in place, Using a red sharpie I marked down where the fan sits with a small rectangle and did a triangle over the motherboard, about where the CPU sits. Unclamped the plexiglass screen and began to work on the cooling vents. Using an X-acto knife, following my outlines to cut out a rectangular hole for the fan and the triangular hole for the CPU. This will allow heat to dissipate off of the CPU as well as allow the fan to intake air more easily. Drilling 32 holes ~1 mm in diameter each, across the near top of the plexiglass for any wandering heat to escape. I cleaned up the edges of the 32 small holes best I could and did the same for the larger holes edges but was able to cover those ones with more yellow electrical tape to give it a cleaner appearance and hopefully avoid the fan whistling. I order rainbow of electrical tape, but have only used yellow black, probably overdoing it just a tad with the yellow, what can i say I'm in a yellow mood.

### Sheer Panic_

The original screen and all traces of it were gone, the spicy pillow was removed, everything was clean, covered and vented. The mini DisplayPort to HDMI was connected, the power button was pressed, and the keyboard light comes on. A huge moment of relief... the brain was alive, it wasn't shorted or damaged during the battle. Then boom! The Windows 10 sign in screen appears on the external Crua monitor. The surface book even scanned my shocked face and logged in automatically! I took some time in Windows to check to see if everything was functioning properly. The WiFi, the headphone jack, SSD and the biggest concern, did the Surface book lock the CPU down due to the missing connector board? It did not... The surface Book 1's CPU is marketed to have a max reading of 2.60 GHz in its original state... with a theoretical of 3.40... Mine, however was sitting pretty at 3.32GHz and alternating semi rapidly as it continued to process while downloading and moving files as I set up the ISO for the windows 10 replacement. This means that not only is the CPU healthy... it's thriving.

But its not over yet.. I need to switch OS's... This device will be running Batocera, a Linux distro for retro games... I powered the surface book off... plugged in the external HDD I had converted to a Ventoy with the Batocera ISO loaded and powered back on... but nothing appeared on my Crua monitor, it stayed black, lifeless. My heart rate skyrocketed, did i just lose? I had thought from the ASUS project's debacle I would've learned and I thought I did, I handled the UEFI this time, i was careful, I adapted and overcame every hurtle thus far... I was the hair when needed as i was the tortoise. Yet here I am... staring at another black screen connected to a motherboard i KNOW is alive. Before hand, with the ASUS, this exact problem arose and the fix ended up being having to plug the LVMs cable of the LCD directly back into the motherboard to alter the BIOS and install the OS... that wasn't an option for the now screen-less surface book. I unplugged and plugged back in the display cable, powered off and on, tried to force the surface book to see with FN + F1... NOTHING. ...I had one idea left... Unplugging the Ventoy drive, I booted back into Windows, which appeared on the Crua monitor with ease. Because windows is already installed, It has all the drivers necessary to talk to the external display... so I ventured into back into the UEFI to manually boot to the USB device... and saw the Ventoy screen appear, but it was claiming the ISO file was unreadable. This is progress... now the only thing in my way is the Ventoy, not the surface books UEFI. I backed out and wiped the drive, opting to burn the Batocera ISO directly to the drive rather than using Ventoy. As I don't know much about code yet, I had Google Gemini help me write some code to tell the ISO file to use the external monitor. This took a while to discover as a possibility and execute, but ultimately worked. Late into the night... I was booted into Batocera!

### Conclude_

This was a wild ride and lot of fun, I don't think it will ever be lost on me how much of an emotional and physical toll these projects can have. It is worth it, every obstacle tacked, every shot in the dark idea and every mistake is a lesson learned. Batocera is running smooth and the surface book is staying cool and looking good, free from its tumorous battery cell and reaching heights it never could before. I understand the original engineers restrictions, they were instructed to make a laptop with a removable screen that could function as an independent touch screen tablet with a beautiful display, they were forced to handicap the devices power to make it appealing to consumers. For a while, it was just that, appealing, new, unique. Time passed, the next new shiny thing came out and the surface book becomes obsolete, slower, tired... years of suffocating while trying to preform and keep up with its user... the thanks it gets is abandonment... destined to fail while expected to be perfect, ultimately ends up forgotten in a landfill.

I am proud to have given my old friend a new life in an environment where he can reach his full potential. This was my trusty partner for years... running various heavy programs like the Adobe suite, blender, games etc... 
...
Left-to-Right:
* **Figure 001** Plexiglass screen with a rectangular hole which will rest over the fan (Bot). A triangular hole above the CPU (Mid). Small holes drilled along the top of the screen for heat to rise and escape from (Top-to-Bot Right).
* **Figure 002** Cutting the rectangular hole out, via predrilled holes and using an X-acto knife to score out.
* **Figure 003** The initial system test and dry fit of the Plexiglass screen before marking and cutting out the holes.
* **Figure 004** One of four small clamps used to hold the plexiglass screen to the chassis as I want It to be modular.
* **Figure 005** Surface book screen on the Crua monitor showcasing the CPU performance improvement. Running it's native Windows 10 before the swap to Linux.
